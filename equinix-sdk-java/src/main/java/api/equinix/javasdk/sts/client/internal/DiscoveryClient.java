...
/**
 * Internal client for the STS unauthenticated discovery endpoints:
 * {@code GET /jwks} (operationId {@code getJwks}) and
 * {@code GET /.well-known/openid-configuration} (operationId {@code getOpenIdConfiguration}).
 */

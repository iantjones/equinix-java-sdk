 ...
 *
 * <p>The central type, {@link api.equinix.javasdk.core.async.EquinixAsync}, is a small generic
 ...
 * covers the whole API surface. {@link api.equinix.javasdk.core.async.AsyncException} reports
 * interruption while awaiting completion.</p>
 *
 * @see api.equinix.javasdk.core.async.EquinixAsync
 */

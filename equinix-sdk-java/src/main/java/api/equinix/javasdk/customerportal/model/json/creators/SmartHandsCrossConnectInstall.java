...
/**
 * A cross-connect entry for a smart hands patch-cable-install order
 * ({@code cross-connect-install} in the smart hands v1 spec). {@code serialNumber},
 * {@code deviceCabinet}, {@code deviceConnectorType}, {@code deviceDetails} and
 * {@code devicePort} are required; {@code lightLinkVerification} and {@code scopeOfWork} are
 * optional.
 */
@Getter
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SmartHandsCrossConnectInstall {
    ...
    @JsonProperty("lightLinkVerification")
    private Boolean lightLinkVerification;

    @JsonProperty("scopeOfWork")
    private String scopeOfWork;

    private SmartHandsCrossConnectInstall(Builder builder) {
        ...
        this.lightLinkVerification = builder.lightLinkVerification;
        this.scopeOfWork = builder.scopeOfWork;
    }

    /**
     * Returns a new builder for a cross-connect install entry.
     *
    ...
    public static class Builder {
        ...
        public Builder lightLinkVerification(Boolean lightLinkVerification) {
        ...
        public SmartHandsCrossConnectInstall build() {
            return new SmartHandsCrossConnectInstall(this);
        }
    }
}

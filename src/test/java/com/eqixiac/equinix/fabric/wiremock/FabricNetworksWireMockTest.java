...
import com.eqixiac.equinix.fabric.enums.NetworkEquinixStatus;
...
class FabricNetworksWireMockTest extends WireMockTestBase {
    ...
    class GetByUuid {
        ...
        void deserializesNewFields() {
            ...
            assertEquals(com.eqixiac.equinix.core.enums.MetroCode.SV, network.getLocation().getMetroCode());
    ...
    class Update {
        ...
        void saveMultipleFields() {
            ...
            network.update()
                    .name("Renamed")
                    .patch(com.eqixiac.equinix.core.http.request.PatchOperation.replace("/scope", "GLOBAL"))
                    .save();

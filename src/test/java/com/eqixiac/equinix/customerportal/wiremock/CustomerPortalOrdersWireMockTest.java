...
import com.eqixiac.equinix.customerportal.enums.OrderNoteType;
...
class CustomerPortalOrdersWireMockTest extends WireMockTestBase {
    ...
    class GetByUuid {
        ...
        void returnsOrder() {
            ...
            assertEquals(com.eqixiac.equinix.customerportal.enums.OrderStatus.IN_PROGRESS, order.getStatus());
    ...
    class Refresh {
        ...
        void refreshReloadsInPlace() {
            ...
            assertEquals(com.eqixiac.equinix.customerportal.enums.OrderStatus.CLOSED, order.getStatus());
            assertEquals(ORDER_ID, order.getOrderId());

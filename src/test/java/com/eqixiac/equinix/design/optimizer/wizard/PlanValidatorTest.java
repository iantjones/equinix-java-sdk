...
class PlanValidatorTest {
    ...
    void evplVcBackboneLinkIsFlagged() {
        PlannedConnection bbConn = PlannedConnection.builder()
                ...
                .build();
        com.eqixiac.equinix.design.optimizer.wizard.model.PlannedBackboneLink link =
                com.eqixiac.equinix.design.optimizer.wizard.model.PlannedBackboneLink.builder()
    ...
    void routerDryRunInfeasibilityIsSkipped() {
        FabricGateway rateLimited = dryRunThrowsGateway(
                new com.eqixiac.equinix.core.exception.EquinixRateLimitException("Rate limit exceeded (HTTP 429)."));
    ...
    void routerDryRunCarriesAllNotificationEmails() {
        ...
        verify(crb).notification(com.eqixiac.equinix.fabric.enums.NotificationType.ALL,

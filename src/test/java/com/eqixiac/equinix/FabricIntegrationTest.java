...
class FabricIntegrationTest extends IntegrationTestBase {
    ...
    class CompanyProfileTests {
        ...
        void companyProfiles_getTags() {
            ...
            List<com.eqixiac.equinix.fabric.model.Tag> tags = requireEntitled("Fabric", "getTags", "Tag", "GET",
    ...
    class TagTests {
        ...
        void tags_list() {
            PaginatedList<com.eqixiac.equinix.fabric.model.Tag> tags = requireEntitled("Fabric", "list", "Tag", "GET",
                    () -> fabric.tags().list());
            assertNotNull(tags);
            if (!tags.isEmpty()) {
                com.eqixiac.equinix.fabric.model.Tag first = tags.get(0);
                assertNotNull(first.getUuid());
                first.getName();
                first.getType();
            }

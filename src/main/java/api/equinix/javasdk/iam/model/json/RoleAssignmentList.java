...
/**
 * Token-paginated JSON model for the IAM {@code RoleAssignmentList} response schema. Wraps
 * a page of {@link RoleAssignmentJson} items along with an opaque continuation token.
 * <p>
...
public class RoleAssignmentList {
    ...
    @JsonProperty("list")
    private List<RoleAssignmentJson> list;

...
/**
 * Token-paginated JSON model for the IAM {@code RoleList} response schema. Wraps a page
 * of {@link RoleJson} items along with an opaque continuation token.
 * <p>

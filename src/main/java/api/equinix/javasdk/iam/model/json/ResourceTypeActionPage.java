...
/**
 * Token-paginated JSON model for the IAM {@code ResourceTypeActionPage} response schema.
 * The wire schema nests a {@code ResourceTypeActionList} (itself an array of
...
public class ResourceTypeActionPage {

    @JsonProperty("list")
    private List<ResourceTypeActionJson> list;

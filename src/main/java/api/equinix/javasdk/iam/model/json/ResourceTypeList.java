...
/**
 * Token-paginated JSON model for the IAM {@code ResourceTypeList} response schema. Wraps a
 * page of {@link ResourceTypeJson} items along with an opaque continuation token.
 * <p>
...
public class ResourceTypeList {
    ...
    @JsonProperty("list")
    private List<ResourceTypeJson> list;

...
public interface SupportCaseClient<T> extends Pageable<T> {
    ...
    SupportCaseJson getByUuid(String uuid);

    SupportCaseJson create(SupportCaseCreatorJson supportCaseCreatorJson);

    SupportCaseJson update(String uuid, SupportCaseCreatorJson supportCaseCreatorJson);

    SupportCaseJson delete(String uuid);

    SupportCaseJson refresh(String uuid);
}

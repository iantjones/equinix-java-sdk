...
public interface UnifiedNotificationClient<T> extends Pageable<T> {

    Page<UnifiedNotification, UnifiedNotificationJson> list();

    UnifiedNotificationJson getByUuid(String uuid);
}

...
public class SecureCabinetWrapper extends ResourceImpl<SecureCabinet> implements SecureCabinet {

    @Delegate(excludes = SecureCabinetMutability.class)
    private SecureCabinetJson jsonObject;
    @Getter
    ...
    public SecureCabinetWrapper(SecureCabinetJson secureCabinetJson, Pageable<SecureCabinet> serviceClient) {
        this.jsonObject = secureCabinetJson;
        this.serviceClient = serviceClient;
    }

    public void refresh() {
        this.jsonObject = ((SecureCabinetClientImpl)this.serviceClient).refresh(this.getUuid());
    }

    private interface SecureCabinetMutability {
        void refresh();
    }
}

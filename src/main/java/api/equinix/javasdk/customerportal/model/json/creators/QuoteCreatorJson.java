...
@Getter
public class QuoteCreatorJson {

    @JsonProperty("quoteNumber") private String quoteNumber;
    @JsonProperty("totalAmount") private String totalAmount;
    @JsonProperty("currency") private String currency;
    @JsonProperty("expirationDate") private String expirationDate;

    public QuoteCreatorJson(QuoteOperator.QuoteBuilder builder) {
        this.quoteNumber = builder.getQuoteNumber();

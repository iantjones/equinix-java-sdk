 ...
 * {@link api.equinix.javasdk.mcp.server.EquinixMcpServerMain} as a subprocess and speaks
 ...
 *       registered via the same {@link api.equinix.javasdk.mcp.server.ToolRegistration}
 *       seam;</li>
 ...
 * </ul>
 *
 * <p>Extension seam: build a {@link api.equinix.javasdk.mcp.server.ToolRegistration} (name,
 * JSON schema, annotations, {@link api.equinix.javasdk.mcp.server.ToolHandler}) and pass it to
 * {@code EquinixMcpServer.builder().additionalTools(...)}; the handler receives the parsed
 * argument JSON and the shared {@link api.equinix.javasdk.mcp.server.ServerContext} of

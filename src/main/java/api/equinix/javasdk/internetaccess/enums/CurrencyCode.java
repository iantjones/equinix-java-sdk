...
/**
 * ISO 4217 currency code of the billing account attached to an Equinix Internet Access (EIA) v1
 * account ({@code GET /internetAccess/v1/accounts}).
 */
public enum CurrencyCode implements APIParam {

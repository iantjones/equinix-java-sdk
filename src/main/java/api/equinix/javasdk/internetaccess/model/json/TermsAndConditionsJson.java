 ...
 * v1 terms lookup ({@code GET /internetAccess/v1/terms}). Implements {@link TermsAndConditions}
...
public class TermsAndConditionsJson implements TermsAndConditions {
    ...
    private TermsConnectivitySource connectivitySource;

    @JsonProperty("type")
    private TermsType type;

    @JsonProperty("product")
    private TermsProduct product;

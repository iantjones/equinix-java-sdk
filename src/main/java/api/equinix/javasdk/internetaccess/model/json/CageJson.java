...
/**
 * Read-only JSON model for a {@link Cage} returned by the Equinix Internet Access (EIA) v1
 * product-availability lookup {@code GET /internetAccess/v1/cages}. Implements {@link Cage}
 * directly, so no wrapper is required.
 */
@Getter
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public class CageJson implements Cage {

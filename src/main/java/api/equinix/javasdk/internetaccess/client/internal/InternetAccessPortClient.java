...
public interface InternetAccessPortClient<T> extends Pageable<T> {

    Page<InternetAccessPort, InternetAccessPortJson> list();

    InternetAccessPortJson getByUuid(String uuid);
}

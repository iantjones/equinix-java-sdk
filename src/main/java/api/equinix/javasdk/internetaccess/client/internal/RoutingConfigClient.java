...
public interface RoutingConfigClient<T> extends Pageable<T> {
    ...
    Page<RoutingConfig, RoutingConfigJson> list();

    RoutingConfigJson getByUuid(String uuid);

    RoutingConfigJson create(RoutingConfigCreatorJson routingConfigCreatorJson);

    RoutingConfigJson update(String uuid, RoutingConfigCreatorJson routingConfigCreatorJson);

    RoutingConfigJson refresh(String uuid);
}

...
import api.equinix.javasdk.networkedge.enums.RebootStatus;
...
/**
 * <p>DeviceReboot class. A single device soft-reboot history entry.</p>
 *
 * @author ianjones
 */
...
public class DeviceReboot {
    ...
    @JsonProperty("completiondDateTime")
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)

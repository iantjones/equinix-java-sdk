 ...
 * {@link api.equinix.javasdk.core.exception.EquinixServiceException} — so a failure in application
 ...
 * {@link api.equinix.javasdk.core.exception.CircuitOpenException} without touching the network.</p>
 *
 * @author ianjones
 */
public class EquinixHttpClient implements Closeable {
     ...
     * fast with a {@link api.equinix.javasdk.core.exception.CircuitOpenException} until the cooldown
     ...
     * {@link api.equinix.javasdk.core.exception.CircuitOpenException}) and its outcome is reported

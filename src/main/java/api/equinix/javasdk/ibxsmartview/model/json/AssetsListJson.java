...
import api.equinix.javasdk.ibxsmartview.model.implementation.Category;
...
/**
 * Deserialization holder for the asset/list response ({@code AssetsList}).
 */
@Getter
@JsonIgnoreProperties(ignoreUnknown = true)
public class AssetsListJson implements AssetsList {

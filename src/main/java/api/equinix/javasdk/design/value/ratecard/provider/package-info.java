 ...
 * {@link api.equinix.javasdk.design.value.ratecard.provider.AwsPriceListRateCard} (AWS
 * Price List bulk offers),
 * {@link api.equinix.javasdk.design.value.ratecard.provider.AzureRetailPricesRateCard}
 * (Azure Retail Prices),
 * {@link api.equinix.javasdk.design.value.ratecard.provider.GcpBillingCatalogRateCard}
 * (GCP Cloud Billing Catalog; the only one needing an API key), and
 * {@link api.equinix.javasdk.design.value.ratecard.provider.OracleCloudPriceListRateCard}
 * (OCI Price List). Every rate they return is tagged
 * {@link api.equinix.javasdk.design.value.ratecard.PriceSource#PROVIDER_API}: live and
 ...
 * @see api.equinix.javasdk.design.value.ratecard.EgressRate
 */

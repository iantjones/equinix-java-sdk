 ...
 * {@link api.equinix.javasdk.design.value.savings.SavingsCalculator.Builder} terminated
 * by {@code calculate()}, which yields a
 * {@link api.equinix.javasdk.design.value.savings.SavingsEstimate} with the net
 * monthly/annual savings, break-even volume, and setup-payback figures. Volumes are
 * expressed via {@link api.equinix.javasdk.design.value.savings.DataUnit} (decimal/SI —
 * 1&nbsp;TB = 1000&nbsp;GB).
 *
 ...
 *
 * @see api.equinix.javasdk.design.value.savings.SavingsCalculator
 * @see api.equinix.javasdk.design.value.savings.SavingsEstimate

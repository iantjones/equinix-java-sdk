 ...
 * {@link api.equinix.javasdk.design.value.tco.DeploymentArchetype}s — public cloud over
 ...
 * {@link api.equinix.javasdk.design.value.tco.TcoCalculator.Builder} terminated by
 * {@code compare()}, which yields a
 * {@link api.equinix.javasdk.design.value.tco.TcoComparison} of per-archetype
 * {@link api.equinix.javasdk.design.value.tco.CostBreakdown}s. Archetypes are ranked by
 ...
 * {@link api.equinix.javasdk.design.value.ratecard}: by default live Equinix Fabric
 ...
 * differ.</p>
 *
 * @see api.equinix.javasdk.design.value.tco.TcoCalculator
 * @see api.equinix.javasdk.design.value.tco.TcoComparison

 ...
 * {@link api.equinix.javasdk.design.value.ratecard.RateCard}, whose lookups (connection,
 ...
 * {@link api.equinix.javasdk.design.value.ratecard.CustomRateCard} (caller-supplied,
 * e.g. negotiated contract rates), then
 * {@link api.equinix.javasdk.design.value.ratecard.EquinixRateCard} (live Fabric
 * Pricing API, term-aware with labelled substitutions), then
 * {@link api.equinix.javasdk.design.value.ratecard.ReferenceRateCard} (bundled, dated
 ...
 * {@link api.equinix.javasdk.design.value.ratecard.PriceQuote} and
 * {@link api.equinix.javasdk.design.value.ratecard.EgressRate} carries its
 * {@link api.equinix.javasdk.design.value.ratecard.PriceSource} provenance and an
 ...
 * @see api.equinix.javasdk.design.value.ratecard.PriceSource
 * @see api.equinix.javasdk.design.value.ratecard.provider
 */

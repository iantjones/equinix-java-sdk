 ...
 * catalog data.
 *
 * <p>{@link api.equinix.javasdk.design.optimizer.MetroOptimizer} is the public entry point — a
 ...
 * {@link api.equinix.javasdk.design.optimizer.model.OptimizationResult} with ranked
 ...
 * weighted per {@link api.equinix.javasdk.design.optimizer.enums.OptimizationStrategy} and
 * overridable via {@link api.equinix.javasdk.design.optimizer.model.ScoringWeights}. Workload
 ...
 * {@link api.equinix.javasdk.design.optimizer.enums.LatencySensitivity} tier's threshold.</p>
 *

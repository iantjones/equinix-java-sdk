 ...
 * <p>Every engine runs over {@link api.equinix.javasdk.FabricGateway} — the narrow capability
 ...
 * {@link api.equinix.javasdk.Design#over(api.equinix.javasdk.FabricGateway)}, the equivalent
 * accessors on {@link api.equinix.javasdk.Fabric} ({@code optimizeMetros()},
 * {@code deploymentWizard(...)}, {@code peeringIntelligence()}, {@code savingsCalculator()},
 * {@code tcoComparison()}), or a shared {@link api.equinix.javasdk.Equinix} session's
 * {@code design()}.</p>
 *
 * @see api.equinix.javasdk.Design
 * @see api.equinix.javasdk.FabricGateway
 */

...
public class StreamAlertRuleCreatorJson {
    ...
    public StreamAlertRuleCreatorJson(StreamAlertRuleOperator.StreamAlertRuleBuilder builder) {
        this.type = builder.getType();
        this.name = builder.getName();
        this.description = builder.getDescription();
        this.enabled = builder.getEnabled();
        this.metricSelector = builder.getMetricSelector();
        this.resourceSelector = builder.getResourceSelector();
        this.detectionMethod = builder.getDetectionMethod();
    }
}

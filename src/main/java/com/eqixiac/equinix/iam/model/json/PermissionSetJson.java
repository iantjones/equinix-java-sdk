...
/**
 * Read-only JSON model for the IAM {@code PermissionSet} response. Implements
 * {@link PermissionSet} directly.
 */
@Getter
@JsonIgnoreProperties(ignoreUnknown = true)
public class PermissionSetJson implements PermissionSet {

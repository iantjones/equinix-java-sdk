...
/**
 * Token-paginated JSON model for the IAM {@code AccessPolicyGrantList} response schema.
...
public class AccessPolicyGrantList {

    @JsonProperty("list")
    private List<AccessPolicyGrantJson> list;

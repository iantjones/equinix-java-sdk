...
import com.eqixiac.equinix.networkedge.client.DeviceLinks;
...
import com.eqixiac.equinix.networkedge.client.implementation.ACLTemplatesImpl;
import com.eqixiac.equinix.networkedge.client.implementation.BGPPeeringsImpl;
import com.eqixiac.equinix.networkedge.client.implementation.BackupsImpl;
import com.eqixiac.equinix.networkedge.client.implementation.DeviceLinksImpl;
import com.eqixiac.equinix.networkedge.client.implementation.DevicesImpl;
...
import com.eqixiac.equinix.networkedge.client.implementation.NetworkEdgeConfigImpl;
import com.eqixiac.equinix.networkedge.client.implementation.PublicKeysImpl;
import com.eqixiac.equinix.networkedge.client.implementation.SetupImpl;
import com.eqixiac.equinix.networkedge.client.implementation.VPNsImpl;
 ...
 * @see com.eqixiac.equinix.networkedge.client.Devices
 * @see com.eqixiac.equinix.networkedge.client.ACLTemplates
 */
public class NetworkEdge extends EquinixClient {
    ...
    /**
     * Creates a new Network Edge client whose credentials are resolved through the given provider.
     * Authentication occurs automatically on the first API call.
     *
     * @param credentialsProvider supplies the OAuth2 credentials for authenticating with Equinix APIs
     */
    public NetworkEdge(EquinixCredentialsProvider credentialsProvider) {
        this(credentialsProvider, false);
    }

    /**
     * Creates a new Network Edge client over a custom credentials provider, with optional sandbox mode.
     *
     * @param credentialsProvider supplies the OAuth2 credentials for authenticating with Equinix APIs
     * @param isSandBoxed {@code true} to use the sandbox environment for testing; {@code false} for production
     */
    public NetworkEdge(EquinixCredentialsProvider credentialsProvider, boolean isSandBoxed) {
    ...
    /**
     * Creates a new NetworkEdge client with explicit {@link EquinixConfig} options.
     *
     * @param equinixCredentials the OAuth2 credentials for authenticating with Equinix APIs
     * @param config the construction-time options
     */
    public NetworkEdge(EquinixCredentials equinixCredentials, EquinixConfig config) {
        this(new EquinixStaticCredentialsProvider(equinixCredentials), config);
    }

    /**
     * Creates a new NetworkEdge client over a custom credentials provider with explicit
     * {@link EquinixConfig} options.
     *
     * @param credentialsProvider supplies the OAuth2 credentials for authenticating with Equinix APIs
     * @param config the construction-time options
     */
    public NetworkEdge(EquinixCredentialsProvider credentialsProvider, EquinixConfig config) {
     ...
     */
    NetworkEdge(com.eqixiac.equinix.core.client.EquinixClient sharedCore) {
        super(sharedCore);

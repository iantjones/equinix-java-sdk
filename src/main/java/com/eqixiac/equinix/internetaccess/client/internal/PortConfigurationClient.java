...
/**
 * Internal client for the Equinix Internet Access (EIA) v1 port-configuration lookup:
 * {@code GET /internetAccess/v1/portConfigurations} — the allowed port configurations for a given
 * IBX and use case.
 */

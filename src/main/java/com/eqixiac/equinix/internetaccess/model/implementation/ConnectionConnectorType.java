...
/**
 * A connector type supported by a media type in the Equinix Internet Access (EIA) v1
 * connection-services lookup ({@code GET /internetAccess/v1/connectionServices}).
 */
@Getter
@JsonIgnoreProperties(ignoreUnknown = true)
public class ConnectionConnectorType {

    @JsonProperty("name")
    private String name;

    @JsonProperty("requiredPorts")
    private Integer requiredPorts;

    @JsonProperty("optionalPorts")

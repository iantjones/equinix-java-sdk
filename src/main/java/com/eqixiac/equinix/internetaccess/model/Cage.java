 ...
 * product-availability lookup {@code GET /internetAccess/v1/cages}.
 *
...
public interface Cage {
    ...
    /**
     * @return the unique space identifier of the cage
     */
    String getSpaceId();

    /**
     * @return the cage number
     */
    String getNumber();

    /**
     * @return the number of cabinets in the cage
     */
    Integer getCabinetsCount();

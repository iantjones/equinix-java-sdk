...
import com.eqixiac.equinix.customerportal.model.SmartHandsAccount;
...
public class SmartHandsAccountJson implements SmartHandsAccount {
    ...
    private List<SmartHandsCabinetJson> cabinets;
}

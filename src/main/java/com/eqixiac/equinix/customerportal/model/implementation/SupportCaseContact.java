...
/**
 * A contact associated with a support case ({@code ContactResponse}). The {@code type} is one of
 * {@code NOTIFICATION}, {@code ORDERING} or {@code TECHNICAL}.
 */
@Getter
...
public class SupportCaseContact {
    ...
    private List<SupportCaseContactDetail> details;
}

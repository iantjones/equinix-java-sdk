...
/**
 * Request body for submitting an outbound shipment order
 * ({@code POST /v1/orders/shipment/outbound}, {@code outboundShipmentRequest} in the shipments v1
 * spec).
 *
...
public class OutboundShipmentOrderRequest {
    ...
    private final OutboundShipmentServiceDetails serviceDetails;
    ...
    private OutboundShipmentOrderRequest(Builder builder) {
    ...
    /**
     * Returns a new builder for an outbound shipment order request.
     *
     ...
     * @param serviceDetails the outbound shipment service details (required)
     * @return a new builder
     */
    public static Builder builder(IbxLocation ibxLocation, List<ContactInfo> contacts,
                                  OutboundShipmentServiceDetails serviceDetails) {
    ...
    public static class Builder {
        ...
        public OutboundShipmentOrderRequest build() {
            return new OutboundShipmentOrderRequest(this);
        }
    }
}

...
/**
 * A related party associated with a quote ({@code Contacts}). Either references a
 * {@code registeredUser} or carries a {@code firstName}/{@code lastName} pair, with a contact
 * {@code type} ({@code QUOTATION} or {@code SUPPLIER}) and a list of communication {@code details}.
 */
@Getter

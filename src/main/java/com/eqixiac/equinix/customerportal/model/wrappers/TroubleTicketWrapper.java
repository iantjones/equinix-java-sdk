...
public class TroubleTicketWrapper extends ResourceImpl<TroubleTicket> implements TroubleTicket {

    @Delegate(excludes = TroubleTicketMutability.class)
    private TroubleTicketJson jsonObject;
    @Getter
    private final Pageable<TroubleTicket> serviceClient;

    public TroubleTicketWrapper(TroubleTicketJson troubleTicketJson, Pageable<TroubleTicket> serviceClient) {
        this.jsonObject = troubleTicketJson;

...
public class DeviceRMARequest {
     ...
     * {@link com.eqixiac.equinix.networkedge.client.Setup#uploadFile}).</p>
     *
     * @param cloudInitFileId the uploaded bootstrap file id.
     * @return this {@link com.eqixiac.equinix.networkedge.model.json.creators.DeviceRMARequest} for chaining.
     */

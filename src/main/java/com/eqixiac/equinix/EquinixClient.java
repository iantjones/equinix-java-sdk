...
import com.eqixiac.equinix.core.client.CoreConfigImpl;
import com.eqixiac.equinix.core.client.CoreImpl;
import com.eqixiac.equinix.core.client.interfaces.Core;
...
public class EquinixClient implements Closeable {
    ...
    @Getter
    final protected com.eqixiac.equinix.core.client.EquinixClient equinixClient;
    ...
    public EquinixClient(EquinixCredentialsProvider credentialsProvider, EquinixConfig config) {
        this.equinixClient = new com.eqixiac.equinix.core.client.EquinixClient(credentialsProvider, config.isSandbox());
     ...
     */
    EquinixClient(com.eqixiac.equinix.core.client.EquinixClient sharedCore) {
     ...
     */
    EquinixClient(com.eqixiac.equinix.core.client.EquinixClient sharedCore, EquinixConfig sessionConfig) {

...
import com.eqixiac.equinix.fabric.client.*;
import com.eqixiac.equinix.fabric.client.implementation.*;
 ...
 * @see com.eqixiac.equinix.fabric.client.Connections
 * @see com.eqixiac.equinix.fabric.client.Ports
 */
@Slf4j
public final class Fabric extends EquinixClient implements FabricGateway {
     ...
     * enrichment).
     */
    Fabric(com.eqixiac.equinix.core.client.EquinixClient sharedCore, EquinixConfig sessionConfig) {
     ...
     * centers within each), keyed by {@link com.eqixiac.equinix.core.model.MetroId} so it covers
     * metros the {@link com.eqixiac.equinix.core.enums.MetroCode} enum does not list. Loaded lazily
     ...
     * {@link com.eqixiac.equinix.design.value.ratecard.CustomRateCard}).
     *
     * <pre>{@code

...
/**
 * Thrown when the Equinix API returns HTTP 404 Not Found.
 * This indicates the requested resource (connection, port, device, etc.)
...
public class EquinixNotFoundException extends EquinixServiceException {
    ...
    public EquinixNotFoundException(String errorMessage) {
        super(errorMessage);
    }

...
/**
 * Thrown when the Equinix API returns HTTP 403 Forbidden.
 * This indicates the authenticated user does not have sufficient permissions
...
public class EquinixAuthorizationException extends EquinixServiceException {
    ...
    public EquinixAuthorizationException(String errorMessage) {
        super(errorMessage);
    }

    public EquinixAuthorizationException(String errorMessage, Exception cause) {
        super(errorMessage, cause);
    }

    public EquinixAuthorizationException(String errorMessage, Integer statusCode, String path,
     ...
     * {@link com.eqixiac.equinix.core.http.ResponseErrorMapper ResponseErrorMapper}.
     *

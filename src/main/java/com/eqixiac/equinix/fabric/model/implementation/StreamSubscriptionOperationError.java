...
/**
 * Error information for stream subscription delivery (the Fabric v4
 * {@code StreamSubscriptionOperationErrors} schema).
 */
@Getter
@JsonIgnoreProperties(ignoreUnknown = true)
public class StreamSubscriptionOperationError {

...
public class StreamOperator extends ResourceImpl<Stream> {
     ...
     * @return a seeded {@link com.eqixiac.equinix.fabric.model.json.creators.StreamOperator.StreamBuilder}
     */
    ...
    public class StreamBuilder {
         ...
         *
         * @return the updated {@link com.eqixiac.equinix.fabric.model.Stream}
         */
        public Stream save() {
            if (targetUuid == null) {

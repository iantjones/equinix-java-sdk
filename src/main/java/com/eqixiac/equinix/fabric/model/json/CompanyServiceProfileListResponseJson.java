...
/**
 * Response wrapper for {@code GET /fabric/v4/companyProfiles/{companyProfileId}/serviceProfiles},
...
public final class CompanyServiceProfileListResponseJson {
    ...
    @JsonProperty("data")
    private List<CompanyServiceProfileJson> data;

    public List<? extends CompanyServiceProfile> getServiceProfiles() {
        return data;
    }
}

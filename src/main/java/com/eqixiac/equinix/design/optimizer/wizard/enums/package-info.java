 ...
 * {@link com.eqixiac.equinix.design.optimizer.wizard.enums.BackboneTopology} (how the recommended
 * metros are meshed with inter-metro backbone links),
 * {@link com.eqixiac.equinix.design.optimizer.wizard.enums.BandwidthStrategy} (how provider
 * connections are sized from workload requirements), and
 * {@link com.eqixiac.equinix.design.optimizer.wizard.enums.ConnectionPurpose} (what role a planned

...
/**
 * The multi-asset details returned by the asset/details POST endpoint, wrapped in the
 * {@code payLoad}/{@code status} envelope ({@code AssetDetailsResponse} in the spec).
 */
public interface AssetDetailsResponse {
    ...
    /**
     * The {@code payLoad} of an {@link AssetDetailsResponse}.
     */
    interface Payload {

        Integer getTotalCount();

        List<AssetDetailsPayload> getAssetDetails();
    }
}

 ...
 * {@link com.eqixiac.equinix.ibxsmartview.model.SensorReading} interface provides
 * access to temperature, humidity, and airflow measurements, while
 * {@link com.eqixiac.equinix.ibxsmartview.model.PowerEvent} represents a power
 * event raised against a monitored asset. These read-only models represent
 * point-in-time facility measurements.
 *
 * @see com.eqixiac.equinix.ibxsmartview.model.SensorReading
 * @see com.eqixiac.equinix.ibxsmartview.model.PowerEvent
 */
